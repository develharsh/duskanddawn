...
const deleteUser = async (req, res) => {
  try {
    ...
    await _models_userModel__WEBPACK_IMPORTED_MODULE_1__/* .default.findByIdAndDelete */ .Z.findByIdAndDelete(id);
    res.json({
      msg: 'Deleted Success!'
    });
  } catch (err) {
...
var __webpack_exports__ = __webpack_require__.X(0, [81], function() { return __webpack_exec__(8236); });
